                                    ...
                                    return (
                                        <React.Fragment key={index}>
                                            ...
                                            {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                                                ...
                                                // 📍 [ข้อ 1 แก้ไขการคลิก] ตรวจสอบว่าช่องนี้ห้ามคลิกสำหรับ User ทั่วไปหรือไม่
                                                ...
                                                return (
                                                    <div key={idx} 
                                                        ...
                                                        onClick={() => {
                                                            // 📍 [ข้อ 1] ผู้ใช้ทั่วไปกดช่องที่มีงานพิเศษ/วันหยุด จะนิ่ง ไม่เด้งล็อกอิน
                                                        ...
                                                        {cellTasks.map((task, tIdx) => {
                                                            ...
                                                            return (
                                                                <div key={task.id || tIdx} 
                                                                    ...
                                                                    onClick={(e) => {
                                                                        e.stopPropagation(); 
                                                                        // 📍 [ข้อ 1] คนทั่วไปกดการ์ดวันลา/กิจกรรมแล้วนิ่ง แอดมินกดแล้วลบได้ปกติ
                                                                        if (task.job_type === 'leave' || task.job_type === 'company_event') {
