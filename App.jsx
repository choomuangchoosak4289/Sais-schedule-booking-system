...
const App = () => {
    ...
    // 📍 [ข้อ 4] สถานะเปิด/ปิด Dropdown เลือกผู้เข้าร่วมกิจกรรม
    ...
    // 📍 [ข้อ 3] State สำหรับลบข้อมูลแบบกลุ่ม
    ...
    // 📍 [ข้อ 3] ฟังก์ชันลบข้อมูลทีละหลายๆ อัน (Bulk Delete) รัดกุมแบบ Custom Pop-up
    ...
    // 📍 [ข้อ 2] ระบบป๊อปอัป Custom Theme สำหรับลบ
    ...
    const handleImageUpload = async (e, docType) => {
        ...
        try {
            ...
            if (res.status === 'ok') { document.getElementById(`${docType}_img_input`).value = res.fileUrl; showSlideToast(`อัปโหลดเอกสาร ${docType} สำเร็จ`, 'success'); } 
        ...
        <div className="app-container" onClick={() => setShowParticipantDropdown(false)}>
            ...
            {currentView === 'admin' && isAdmin && (
                <div className="page-view">
                    ...
                    {/* 📍 [ข้อ 3] ฟอร์มตั้งค่าวันลา พร้อมระบบเลือกลบได้หลายรายการ */}
                    {adminTab === 'leaves' && (
                        <div className="animate-pop space-y-4 pb-10">
                            ...
                            {/* 📍 [ข้อ 3] ระบบ Bulk Delete เลือกติ๊กได้หลายอันเพื่อลบ */}
                    ...
                    {/* 📍 [ข้อ 4] ฟอร์มตั้งค่ากิจกรรมแบบ Custom Dropdown (กดกาง/หุบได้) */}
                    {adminTab === 'events' && (
                        <div className="animate-pop space-y-4 pb-10">
                            <form onSubmit={async (e) => {
                                e.preventDefault(); 
                                ...
                                <div className="space-y-3">
                                    ...
                                    {/* 📍 [ข้อ 4] UI เลือกผู้เข้าร่วมแบบ Dropdown ที่มี Checkbox ข้างใน */}
                            ...
                            {/* 📍 [ข้อ 3] ระบบ Bulk Delete สำหรับกิจกรรม */}
                    ...
                    {/* 📍 [ข้อ 3] ฟอร์มตั้งค่าวันหยุด พร้อมระบบ Bulk Delete */}
                    {adminTab === 'holidays' && (
                        <div className="animate-pop space-y-4 pb-10">
                            <form onSubmit={async (e) => {
            ...
            {/* 📍 ป๊อปอัปแจ้งเตือนทั้งหมดถูกแก้ไขให้เป็น Custom Modal */}
            {alertMsg && (
