                                                ...
                                                return (
                                                    <div key={idx} 
                                                        ...
                                                        {cellTasks.map((task, tIdx) => {
                                                            ...
                                                            // 📍 2. ดักจับและแยกประเภทสีการ์ดใหม่ให้ถูกต้อง
                                                            ...
                                                            const isHolidayCard = task.job_type === 'public_holiday' || String(task.equipment_no || '').toLowerCase().startsWith('hld_');
                                                            ...
                                                            return (
                                                                <div key={task.id || tIdx} 
                                                                    ...
                                                                    className={`task-content ${cardTypeClass}`}
                                                                    onClick={(e) => {
                                                                        e.stopPropagation(); 
