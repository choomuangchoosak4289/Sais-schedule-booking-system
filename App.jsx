                                            ...
                                            {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                                                ...
                                                return (
                                                    <div key={idx} 
                                                        ...
                                                        {/* 📍 [ข้อ 1] วนลูปการ์ดเต็มช่อง และฟอนต์ปรับขนาดอัตโนมัติ */}
                ...
                <div className="page-view">
                    ...
                    {adminTab === 'leaves' && (
                        <div className="animate-pop space-y-4 pb-10">
                            ...
                            {/* 📍 [ข้อ 3] ระบบ Bulk Delete สำหรับวันลา */}
                        ...
                        <div className="animate-pop space-y-4 pb-10">
                            <form onSubmit={async (e) => {
                                ...
                                <div className="space-y-3">
                                    ...
                                    {/* 📍 [ข้อ 4] UI เลือกผู้เข้าร่วมแบบ Dropdown */}
                    ...
                    {adminTab === 'holidays' && (
                        <div className="animate-pop space-y-4 pb-10">
                            ...
                            {/* 📍 [ข้อ 3] ระบบ Bulk Delete สำหรับวันหยุด */}
