                                ...
                                <div className="space-y-6 text-sm text-slate-700 leading-relaxed">
                                    ...
                                    <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-200">
                                        ...
                                        <ul className="list-disc pl-5 space-y-1 text-xs text-emerald-800">
                                            ...
                                            <li><b>การลบ:</b> จะมีลิสต์รายการแสดงอยู่ด้านล่าง คุณสามารถติ๊ก <span className="bg-red-600 text-white px-1 rounded">Checkbox</span> หลายๆ รายการพร้อมกัน แล้วกดปุ่มลบทิ้งในครั้งเดียวได้</li>
                                        </ul>
                                    </div>
