...
const App = () => {
    ...
    const leaveDates = useMemo(() => {
        ...
        while (current <= end) {
            ...
            // 📍 [ข้อ 4] วันลามีความสำคัญกว่ากิจกรรมบริษัท ไม่ต้องเอาไปหักลบ ให้มันแสดงทับไปเลย
    ...
    const handleDrop = async (e, targetDate, targetInspector) => {
        ...
        // 📍 [ข้อ 2, 3] อนุญาตให้แอดมินลากงานทับซ้อนได้ 
    ...
    const handleBookingSubmit = async (e) => {
        ...
        // 📍 [ข้อ 1 แก้จอขาว 100%] ป้องกัน Object Undefined 
        ...
        // 📍 [ข้อ 2, 3] อนุญาตให้แอดมินจองทับซ้อนได้ บล็อกเฉพาะเลข Eq. เดิมในวันเดียวกัน
        const isDup = (db.bookings || []).some(b => {
            ...
            // ถ้าไม่ใช่แอดมิน ห้ามจองผู้ตรวจซ้ำในวันเดียวกัน 
    ...
    return (
        <div className="app-container">
            ...
            {/* 📍 [ข้อ 6] ปรับเมนูด้านล่างสุด ย้ายค้นหามาไว้ที่นี่ */}
            ...
            {currentView === 'calendar' && (
                <div className="grid-container">
                    ...
                    {/* นำแถบค้นหาออกไปจากหน้าปฏิทินตามคำขอ */}
                            ...
                            <div className="calendar-grid" style={{ '--col-count': (db.inspectors || []).length || 1 }}>
                                ...
                                {(db.inspectors || []).map((ins, i) => (
                                    <div key={i} className="sticky-top">
                                        {/* 📍 [ข้อ 2] เอาตัวย่อชื่อผู้ตรวจออก และบีบให้แคบลง */}
                                            ...
                                            {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                                                ...
                                                return (
                                                    <div key={idx} 
                                                        ...
                                                        {/* 📍 [ข้อ 4] ซ่อนกิจกรรมรวม หากคนๆ นั้นมีการลา (วันลามีความสำคัญกว่า) */}
                                                        ...
                                                        {/* 📍 [ข้อ 4] ลบคำว่า HOLIDAY ออกในวันอาทิตย์ที่ไม่มีกิจกรรม */}
            ...
            {/* 📍 [ข้อ 6] สร้างหน้าต่างค้นหางาน (นำเมนูทุกพื้นที่ และช่องค้นหา มารวมกัน) */}
            {currentView === 'search' && (
                        ...
                        <div className="animate-pop pb-10">
                            <div className="flex justify-between items-center mb-4">
                                <button onClick={() => {
                                    ...
                                    // 📍 [ข้อ 1] แก้จอขาว: กำหนด isAdminOverride ป้องกัน Error
                        ...
                        <div className="p-6 overflow-y-auto">
                            ...
                            {modal.type === 'booking' ? (
                                <form onSubmit={handleBookingSubmit} className="space-y-3">
                                    ...
                                    {/* 📍 [ข้อ 1 แก้จอขาว] ตรวจสอบว่าเป็นแอดมินมาจากหน้าตั้งค่าหรือไม่ โดยใช้ Optional Chaining อย่างปลอดภัย */}
