...
const App = () => {
    ...
    // 📍 [ข้อ 2] ระบบคำนวณเวลาเป็น ชั่วโมง นาที
    ...
    const handleBookingSubmit = async (e) => {
        ...
        // 📍 [ข้อ 3] ปลดล็อกให้แอดมินไม่ต้องใส่เบอร์ช่างได้
                                    ...
                                    return (
                                        <React.Fragment key={index}>
                                            ...
                                            {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                                                ...
                                                const hasEvent = cellTasks.some(t => t.job_type === 'company_event');
                                                ...
                                                return (
                                                    <div key={idx} 
                                                        ...
                                                        {cellTasks.map((task, tIdx) => {
                                                            ...
                                                            // 📍 [ข้อ 1 แก้สีการ์ดเพี้ยน] ระบบ AI ดักจับคำอัจฉริยะ (ดักว่าพิมพ์ Meeting เข้ามาเองหรือเปล่า)
                                ...
                                <div className="space-y-3">
                                    ...
                                    {(leaveStartDate && leaveEndDate && leaveInspector) && (
                                        <div className="p-3 bg-white border border-yellow-300 rounded-lg text-center shadow-sm">
                                            ...
                                            {/* 📍 [ข้อ 2] แสดงสรุปเวลาชั่วโมง/นาที */}
                        ...
                        <div className="p-6 overflow-y-auto">
                            ...
                            {modal.type === 'booking' ? (
                                <form onSubmit={handleBookingSubmit} className="space-y-3">
                                    ...
                                    {/* 📍 [ข้อ 3] แอดมินกรอกฟอร์มได้ไวขึ้น โดยไม่ต้องกรอก Foreman กับ Tel ก็ได้ */}
